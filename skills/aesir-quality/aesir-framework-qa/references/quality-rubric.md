...
Used by `/aesir-skill-test category [name|all]` to evaluate skills beyond structural compliance.
...
| Metric | PASS criteria |
|---|---|
| **U1 — Passes all 7 static checks** | `/aesir-skill-test static [name]` returns COMPLIANT with 0 FAILs |
