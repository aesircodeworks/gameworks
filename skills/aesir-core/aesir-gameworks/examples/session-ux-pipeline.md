...
# Example Session: UX Pipeline — /aesir-ux-design → /aesir-ux-review → /aesir-team-ui
...
## Part 1: HUD Design with /aesir-ux-design
...
**Agent (ux-designer, via /aesir-ux-design):**
...
## Part 2: Inventory Screen with /aesir-ux-design

### Turn 8: User Starts Inventory Screen

**User:**
> /aesir-ux-design screen inventory
...
## Part 3: /aesir-ux-review

### Turn 13: User Runs Review

**User:**
> /aesir-ux-review design/ux/

### Turn 14: Agent Reviews Both Documents

**Agent (via /aesir-ux-review):**
...
>
> Two issues must be resolved before handoff to /aesir-team-ui:
>
...
## Part 4: Handoff to /aesir-team-ui
...
**Agent (via /aesir-team-ui):**
> Running UX pipeline context check...
>
> - `design/ux/hud.md` — reviewed ✅
> - `design/ux/screens/inventory.md` — reviewed ✅
> - `/aesir-ux-review` verdict: NEEDS REVISION was resolved — current state: APPROVED ✅
>
...
- **UX review is a hard gate**: `/aesir-team-ui` checks for a passing `/aesir-ux-review` before proceeding to visual design
...
- **Section-by-section UX authoring**: same incremental pattern as `/aesir-design-system` — each section written to file before moving on
- **Separate HUD and screen files**: `design/ux/hud.md` is the whole-game HUD; per-screen specs live in `design/ux/screens/`
- **Pattern library enforced by /aesir-team-ui**: after this session, inventory drag-drop becomes a documented pattern in `design/ux/interaction-patterns.md` for all future screens to reference
