...
# Example Session: Using /aesir-design-system to Author a GDD

**Context:** Solo indie dev, week 3 of project. `/aesir-map-systems` already ran and produced `design/gdd/systems-index.md`. The movement system is listed as MVP tier, Foundation priority.
...
**Turns:** 14
**Outcome:** Complete `design/gdd/movement-system.md` with all 8 required sections written to file, ready for `/aesir-design-review`
...
**User:**
> /aesir-design-system movement

## Turn 2: Agent Loads Context and Presents the Plan

**Agent (game-designer, via /aesir-design-system):**
...
>
> **Recommended next step:** Run `/aesir-design-review design/gdd/movement-system.md` before moving to the next system in your queue (stamina is next in dependency order, per systems-index).
>
