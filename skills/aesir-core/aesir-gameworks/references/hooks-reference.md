...
| `detect-gaps.sh` | SessionStart | Session begins | Detects fresh projects (suggests /aesir-start) and missing documentation when code/prototypes exist, suggests /aesir-reverse-document or /aesir-project-stage-detect |
...
| `validate-skill-change.sh` | PostToolUse (Write/Edit) | Skill file changes | Advises running `/aesir-skill-test` after any `(game-workspace)/skills/` file is written or edited |

Hook reference documentation: `aesir-gameworks references/hooks/`
Hook input schema documentation: `aesir-gameworks references/hooks/hook-input-schemas.md`
