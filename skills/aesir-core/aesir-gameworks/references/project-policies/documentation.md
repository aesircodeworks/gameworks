...
Use the ADR template: `aesir-project-templates templates/architecture-decision-record.md`
...
- Use `/aesir-architecture-decision` to create ADRs through the guided flow
...
- Updated by `/aesir-architecture-review` Phase 8

**Control Manifest:** `docs/architecture/control-manifest.md`
- Flat programmer rules sheet: Required / Forbidden / Guardrails per layer
- Date-stamped `Manifest Version:` in header
- Stories embed this version; `/aesir-story-done` checks for staleness

**Validation:** Run `/aesir-architecture-review` after completing a set of ADRs.
