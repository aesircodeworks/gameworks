...
Skills with `model: haiku`: `/aesir-help`, `/aesir-sprint-status`, `/aesir-story-readiness`, `/aesir-scope-check`,
`/aesir-project-stage-detect`, `/aesir-changelog`, `/aesir-patch-notes`, `/aesir-onboard`

Skills with `model: opus`: `/aesir-review-all-gdds`, `/aesir-architecture-review`, `/aesir-gate-check`
...
than waiting. Example: `/aesir-review-all-gdds` Phase 1 (consistency) and Phase 2
(design theory) are independent — spawn both at the same time.

### Agent Teams (experimental — opt-in)
Multiple independent Hermes Agent *sessions* running simultaneously, coordinated
