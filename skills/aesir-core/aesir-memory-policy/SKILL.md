...
- Role-specific Claude memories belong in the corresponding `aesir-agent-*` skill (see `aesir-agent-lead-programmer` `references/upstream-memory.md`).
