...
Verified by reading the agent's `skill_view('aesir-agent-lead-programmer')` frontmatter:
...
- Tech debt assessment and prioritization are not covered here — deferred to /aesir-tech-debt skill integration.
