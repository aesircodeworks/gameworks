---
name: aesir-agent-lead-programmer
description: Use when delegating work to the lead-programmer role. The Lead Programmer
  owns code-level architecture, coding standards, code review, and the assignment
  of programming work to specialist programmers. Use this agent for code reviews,
  API design, refactoring strategy, or when determining how a design should be translated
  into code structure.
version: 1.0.0
