...
Verified by reading the agent's `skill_view('aesir-agent-art-director')` frontmatter:
...
## Coverage Notes
- AD-PHASE-GATE (full visual phase advancement) is not covered — deferred to integration with /aesir-gate-check skill.
