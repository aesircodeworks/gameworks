---
name: aesir-agent-systems-designer
description: Use when delegating work to the systems-designer role. The Systems Designer
  creates detailed mechanical designs for specific game subsystems -- combat formulas,
  progression curves, crafting recipes, status effect interactions. Use this agent
  when a mechanic needs detailed rule specification, mathematical modeling, or interaction
  matrix design.
version: 1.0.0
