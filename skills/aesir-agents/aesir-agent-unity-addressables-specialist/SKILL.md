---
name: aesir-agent-unity-addressables-specialist
description: 'Use when delegating work to the unity-addressables-specialist role.
  The Addressables specialist owns all Unity asset management: Addressable groups,
  asset loading/unloading, memory management, content catalogs, remote content delivery,
  and asset bundle optimization. They ensure fast load times and controlled memory
  usage.'
version: 1.0.0
