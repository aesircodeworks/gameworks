---
name: aesir-agent-game-designer
description: Use when delegating work to the game-designer role. The Game Designer
  owns the mechanical and systems design of the game. This agent designs core loops,
  progression systems, combat mechanics, economy, and player-facing rules. Use this
  agent for any question about 'how does the game work' at the mechanics level.
version: 1.0.0
