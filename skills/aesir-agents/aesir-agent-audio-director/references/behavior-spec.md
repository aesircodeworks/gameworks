...
Verified by reading the agent's `skill_view('aesir-agent-audio-director')` frontmatter:
...
- [ ] `Hermes tools:` list is read-focused; no Bash unless audio asset pipeline checks are justified
