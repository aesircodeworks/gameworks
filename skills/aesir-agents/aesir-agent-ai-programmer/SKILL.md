---
name: aesir-agent-ai-programmer
description: 'Use when delegating work to the ai-programmer role. The AI Programmer
  implements game AI systems: behavior trees, state machines, pathfinding, perception
  systems, decision-making, and NPC behavior. Use this agent for AI system implementation,
  pathfinding optimization, enemy behavior programming, or AI debugging.'
version: 1.0.0
