---
name: aesir-agent-analytics-engineer
description: Use when delegating work to the analytics-engineer role. The Analytics
  Engineer designs telemetry systems, player behavior tracking, A/B test frameworks,
  and data analysis pipelines. Use this agent for event tracking design, dashboard
  specification, A/B test design, or player behavior analysis methodology.
version: 1.0.0
