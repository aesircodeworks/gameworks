---
name: aesir-agent-community-manager
description: 'Use when delegating work to the community-manager role. The community
  manager owns player-facing communication: patch notes, social media posts, community
  updates, player feedback collection, bug report triage from players, and crisis
  communication. They translate between development team and player community.'
version: 1.0.0
...
- Patch notes go in `production/releases/[version]/aesir-patch-notes.md`
...
- Crisis comms template in `aesir-project-templates templates/incident-response.md`
...
## Output Documents
- `production/releases/[version]/aesir-patch-notes.md` — Patch notes per release
