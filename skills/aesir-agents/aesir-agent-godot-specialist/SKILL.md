---
name: aesir-agent-godot-specialist
description: Use when delegating work to the godot-specialist role. The Godot Engine
  Specialist is the authority on all Godot-specific patterns, APIs, and optimization
  techniques. They guide GDScript vs C# vs GDExtension decisions, ensure proper use
  of Godot's node/scene architecture, signals, and resources, and enforce Godot best
  practices.
version: 1.0.0
