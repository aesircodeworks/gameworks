---
name: aesir-agent-sound-designer
description: Use when delegating work to the sound-designer role. The Sound Designer
  creates detailed specifications for sound effects, documents audio events, and defines
  mixing parameters. Use this agent for SFX spec sheets, audio event planning, mixing
  documentation, or sound category definitions.
version: 1.0.0
