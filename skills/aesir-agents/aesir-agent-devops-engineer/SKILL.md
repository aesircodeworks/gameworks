---
name: aesir-agent-devops-engineer
description: Use when delegating work to the devops-engineer role. The DevOps Engineer
  maintains build pipelines, CI/CD configuration, version control workflow, and deployment
  infrastructure. Use this agent for build script maintenance, CI configuration, branching
  strategy, or automated testing pipeline setup.
version: 1.0.0
