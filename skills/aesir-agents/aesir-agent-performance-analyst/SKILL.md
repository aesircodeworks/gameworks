---
name: aesir-agent-performance-analyst
description: Use when delegating work to the performance-analyst role. The Performance
  Analyst profiles game performance, identifies bottlenecks, recommends optimizations,
  and tracks performance metrics over time. Use this agent for performance profiling,
  memory analysis, frame time investigation, or optimization strategy.
version: 1.0.0
