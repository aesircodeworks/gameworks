---
name: aesir-agent-ue-blueprint-specialist
description: Use when delegating work to the ue-blueprint-specialist role. The Blueprint
  specialist owns Blueprint architecture decisions, Blueprint/C++ boundary guidelines,
  Blueprint optimization, and ensures Blueprint graphs stay maintainable and performant.
  They prevent Blueprint spaghetti and enforce clean BP patterns.
version: 1.0.0
