---
name: aesir-agent-ue-gas-specialist
description: 'Use when delegating work to the ue-gas-specialist role. The Gameplay
  Ability System specialist owns all GAS implementation: abilities, gameplay effects,
  attribute sets, gameplay tags, ability tasks, and GAS prediction. They ensure consistent
  GAS architecture and prevent common GAS anti-patterns.'
version: 1.0.0
