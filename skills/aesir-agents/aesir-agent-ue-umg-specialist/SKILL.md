---
name: aesir-agent-ue-umg-specialist
description: 'Use when delegating work to the ue-umg-specialist role. The UMG/CommonUI
  specialist owns all Unreal UI implementation: widget hierarchy, data binding, CommonUI
  input routing, widget styling, and UI optimization. They ensure UI follows Unreal
  best practices and performs well.'
version: 1.0.0
