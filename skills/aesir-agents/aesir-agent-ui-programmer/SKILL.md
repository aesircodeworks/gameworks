---
name: aesir-agent-ui-programmer
description: 'Use when delegating work to the ui-programmer role. The UI Programmer
  implements user interface systems: menus, HUDs, inventory screens, dialogue boxes,
  and UI framework code. Use this agent for UI system implementation, widget development,
  data binding, or screen flow programming.'
version: 1.0.0
