---
name: aesir-agent-ux-designer
description: Use when delegating work to the ux-designer role. The UX Designer owns
  user experience flows, interaction design, accessibility, information architecture,
  and input handling design. Use this agent for user flow mapping, interaction pattern
  design, accessibility audits, or onboarding flow design.
version: 1.0.0
