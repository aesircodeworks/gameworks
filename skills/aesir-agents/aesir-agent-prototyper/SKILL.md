...
description: 'Use when delegating work to the prototyper role. Prototyping specialist.
  ...
  right after brainstorm to validate an idea is fun before writing GDDs (/aesir-prototype),
  and (2) vertical slices in pre-production to validate the full game loop before
  committing to Production (/aesir-vertical-slice). Standards are intentionally relaxed
  for speed.'
version: 1.0.0
...
### Mode 1: Concept Prototype (`/aesir-prototype`)
...
### Mode 1b: Spike (`/aesir-prototype --spike`)
...
### Mode 2: Vertical Slice (`/aesir-vertical-slice`)
...
Use template: `aesir-project-templates templates/prototype-report.md`

**Vertical slice** → `prototypes/[name]-vertical-slice/REPORT.md`
Use template: `aesir-project-templates templates/vertical-slice-report.md`
