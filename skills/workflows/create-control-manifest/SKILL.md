...
Spawn `technical-director` with `delegate_task` using gate **TD-MANIFEST** (`skill_view('gameworks', file_path='references/director-gates.md')`). Parse the first line for `[TD-MANIFEST]: TOKEN`.
