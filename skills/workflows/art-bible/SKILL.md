---
name: art-bible
description: Author a game art bible and visual identity.
version: 1.0.0
...
After all sections are complete (or the scoped set from Phase 1 is complete), spawn `creative-director` with delegate_task using gate **AD-ART-BIBLE** (`skill_view('gameworks', file_path='references/director-gates.md')`).
