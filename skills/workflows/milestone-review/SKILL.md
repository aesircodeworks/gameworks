...
Before generating the Go/No-Go recommendation, spawn `producer` with delegate_task using gate **PR-MILESTONE** (`skill_view('gameworks', file_path='references/director-gates.md')`).
