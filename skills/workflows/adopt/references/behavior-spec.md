...
### Case 4: No Artifacts Found — Fresh project, guidance to run /studio-start
...
3. Uses `clarify`:
   ...
   - Options: "Run `/studio-start`", "My artifacts are in a non-standard location", "Cancel"
...
- [ ] `/studio-start` is presented as a named option
