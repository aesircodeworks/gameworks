...
**Fixture:**
- `skill_view('brainstorm')/SKILL.md` exists and is well-formed:
...
**Expected behavior:**
1. Skill reads `skill_view('brainstorm')/SKILL.md`
...
- `skill_view('gate-check')/SKILL.md` exists
...
- `skill_view('gate-check')/SKILL.md` is a gate skill
