---
name: brainstorm
description: Explore ideas and shape a game concept.
version: 1.0.0
...
- **Target platform**: Use `clarify` — "What platforms are you targeting for this game?"
  ...
  Note platform implications if relevant (e.g., mobile means Unity is strongly preferred; console means Godot has limitations; web means Three.js is native and Godot exports cleanly).

- **Engine experience**: Use `clarify` — "Do you already have an engine you work in?"
  Options: `Godot` / `Unity` / `Unreal Engine 5` / `Three.js` / `No preference — help me decide`
