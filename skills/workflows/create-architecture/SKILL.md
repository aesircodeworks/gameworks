...
Apply gate **TD-ARCHITECTURE** (`gameworks references/director-gates.md`) as a self-review. Check all four criteria from that gate definition against the completed document.
