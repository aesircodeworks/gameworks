...
**🟡 Brief Overview Only** - Links to official docs, use web_search for details
...
## On-Demand web_search Strategy

For plugins NOT listed above, use the following approach when users ask:

1. **web_search** for latest documentation: `"Unreal Engine 5.7 [plugin name]"`
