...
**Next steps:**
1. `/aesir-design-review design/gdd/game-concept.md`
2. `/aesir-gate-check`
3. `/aesir-map-systems`
4. `/aesir-design-system [mechanic]` (use learnings in Tuning Knobs and Formulas sections)
...
**Next step:** `/aesir-prototype [revised-concept]`
...
**Next step:** `/aesir-brainstorm [new-direction]`
