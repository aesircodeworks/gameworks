...
- Run `/aesir-balance-check` on [specific aspect]
...
- [ ] **Balance pass**: Run `/aesir-balance-check` on progression curve
...
**Related Skills**:
- `/aesir-balance-check` — Validate formulas and progression
- `/aesir-architecture-decision` — Document technical decisions
- `/aesir-code-review` — Ensure code matches clarified design

---

*This document was generated by `/aesir-reverse-document design [path]`*
