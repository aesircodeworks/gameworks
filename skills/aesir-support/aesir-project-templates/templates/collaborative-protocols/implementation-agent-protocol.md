...
File is ready. Would you like me to:
 ...
 C) Run /aesir-code-review for architecture validation"
...
You: [creates tests/combat/test_damage_calculator.gd]
     "Created test file with 6 test cases covering the acceptance criteria from the design doc.
      ...
      Running /aesir-story-done to verify acceptance criteria and close out the story."

[/aesir-story-done runs — verifies criteria, checks deviations, prompts code review, updates story status]
```
