...
- `/aesir-reverse-document [type] [path]` — [For which gap]
- `/aesir-architecture-decision` — [For which gap]
- `/aesir-sprint-plan` — [If production planning missing]
- `/aesir-milestone-review` — [If approaching deadline]
- `/aesir-onboard [role]` — [If new contributor joining]
...
*Generated by `/aesir-project-stage-detect` skill*
