...
Critical paths to verify before QA hand-off (run via `/aesir-smoke-check`):
...
*Results and sign-off are tracked in the QA sign-off report generated by `/aesir-team-qa` — not in this plan file.*

*Template: `aesir-project-templates templates/test-plan.md`*
*Generated by: `/aesir-qa-plan` — do not edit this line*
