...
<!-- Living document — updated by /aesir-architecture-review after each review run.
...
| TR-[gdd]-002 | [filename] | [system name] | [one-line summary] | — | ❌ GAP | Needs `/aesir-architecture-decision [title]` |
...
**When running `/aesir-architecture-review`**: The skill will update this document
