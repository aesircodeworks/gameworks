...
>
> Your phase gate is logged. Run `/studio-help` at any time during Technical Setup to see your current progress against the required checklist.
...
- **Stage.txt is the authority**: the status line, `/studio-help`, and all skills read from `production/stage.txt` — updating it here changes what every subsequent skill sees
