...
- `AGENTS.md` and `docs/technical-preferences.md` exist (engine configured: Godot 4.6)
...
> |------------------|-------|-------|
> | Engine configuration | ✅ | Godot 4.6 in `AGENTS.md` and `docs/technical-preferences.md` |
...
> - ✅ `/studio-help` — can now show correct phase workflow
>
