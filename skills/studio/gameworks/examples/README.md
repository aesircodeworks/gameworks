...
- stage.txt update changes what `/studio-help`, `/sprint-status`, and all skills see going forward
...
- **Full Principle Documentation:** [collaborative-design-principle.md](../references/collaborative-design-principle.md)
- **Workflow Guide:** [workflow-guide.md](../references/workflow-guide.md)
- **Agent Roster:** [agent-roster.md](../references/agent-roster.md)
