...
Hermes Agent works with any editor, but the template is optimized for:
- **VS Code** with the Hermes Agent extension
- **Cursor** (Hermes Agent compatible)
- Terminal-based Hermes Agent CLI
