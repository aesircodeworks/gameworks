...
Create `(game-workspace)/settings.local.json` for personal overrides that should NOT
...
Hermes Agent supports different permission modes. Recommended for game dev:
