...
# Skill Test Spec: /aesir-balance-check

## Skill Summary

`/aesir-balance-check` reads balance data files (JSON or YAML in `assets/data/`) and
...
3. Skill outputs: "Cannot validate economy stats — no formulas defined. Run /aesir-design-system first."
...
- [ ] Output recommends running `/aesir-design-system` to define formulas
