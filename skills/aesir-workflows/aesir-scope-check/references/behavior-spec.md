...
# Skill Test Spec: /aesir-scope-check

## Skill Summary

`/aesir-scope-check` is a Haiku-tier read-only skill that analyzes a feature, sprint,
...
- [ ] Output suggests running `/aesir-milestone-review` or creating a milestone
...
**Input:** `/aesir-scope-check production/epics/combat/story-parry-timing.md`
