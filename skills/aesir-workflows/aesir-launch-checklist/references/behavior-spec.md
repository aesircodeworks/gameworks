...
# Skill Test Spec: /aesir-launch-checklist

## Skill Summary

`/aesir-launch-checklist` generates and evaluates a complete launch readiness checklist
...
director gates apply — `/aesir-team-release` orchestrates the full release pipeline. Verdicts:
...
- [ ] Has a next-step handoff (e.g., `/aesir-team-release` or `/aesir-day-one-patch`)

---

## Director Gate Checks

None. `/aesir-launch-checklist` is a readiness audit utility. The full release pipeline
is managed by `/aesir-team-release`.
