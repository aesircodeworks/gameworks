...
# Skill Test Spec: /aesir-retrospective

## Skill Summary

`/aesir-retrospective` generates a structured sprint or milestone retrospective
...
**Input:** `/aesir-retrospective sprint-005`
...
- User re-runs `/aesir-retrospective sprint-005` after changes
...
- User runs `/aesir-retrospective sprint-005`
