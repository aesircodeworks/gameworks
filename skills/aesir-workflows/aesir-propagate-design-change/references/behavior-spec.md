...
# Skill Test Spec: /aesir-propagate-design-change

## Skill Summary

`/aesir-propagate-design-change` handles GDD revision cascades. When a GDD is updated,
...
**Input:** `/aesir-propagate-design-change design/gdd/[system].md`
...
**Input:** `/aesir-propagate-design-change` (no argument)

**Expected behavior:**
1. Skill detects no argument is provided
2. Skill outputs a usage error: "No GDD specified. Usage: /aesir-propagate-design-change design/gdd/[system].md"
