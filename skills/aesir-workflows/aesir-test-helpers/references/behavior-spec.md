...
# Skill Test Spec: /aesir-test-helpers

## Skill Summary

`/aesir-test-helpers` generates engine-specific test helper utilities for the project's
...
None. `/aesir-test-helpers` is a scaffolding utility. No director gates apply.
...
**Input:** `/aesir-test-helpers player-factory`
...
### Case 2: No Test Setup Exists — Redirects to /aesir-test-setup
...
3. Skill suggests running `/aesir-test-setup` before generating helpers
4. No helper file is created

**Assertions:**
- [ ] Error message identifies the missing tests/ directory
- [ ] `/aesir-test-setup` is suggested as the prerequisite step
...
**Input:** `/aesir-test-helpers enemy-factory`
...
**Input:** `/aesir-test-helpers inventory-factory`
