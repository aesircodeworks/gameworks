...
# Skill Test Spec: /aesir-estimate

## Skill Summary

`/aesir-estimate` estimates task or story effort using a relative-size scale (S / M /
...
**Input:** `/aesir-estimate production/epics/combat/story-hitbox-detection.md`
...
**Input:** `/aesir-estimate production/epics/online/story-lobby-matchmaking.md`
...
**Input:** `/aesir-estimate production/epics/core/story-save-load.md`
...
**Input:** `/aesir-estimate production/sprints/sprint-007.md`
...
**Input:** `/aesir-estimate production/epics/core/story-item-pickup.md`
...
4. Skill notes: "Use this estimate in /aesir-sprint-plan when selecting stories for the next sprint"

**Assertions:**
- [ ] No director gate is invoked regardless of review mode
- [ ] Output is purely informational — no approval or write prompt
- [ ] Next-step recommendation references `/aesir-sprint-plan`
