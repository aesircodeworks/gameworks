...
# Skill Test Spec: /aesir-design-review

## Skill Summary

`/aesir-design-review` reads a game design document (GDD) and evaluates it against
...
**Input:** `/aesir-design-review design/gdd/light-manipulation.md`
...
**Input:** `/aesir-design-review design/gdd/[document].md`
...
**Input:** `/aesir-design-review design/gdd/nonexistent.md`
...
**Input:** `/aesir-design-review design/gdd/light-manipulation.md` (with full review mode active)
...
- [ ] Ends with recommended next step (e.g., fix issues and re-run, or proceed to `/aesir-map-systems`)
...
- Cross-system consistency checking (Case 3 in the skill's own phase list) is
  ...
  this is covered by the `/aesir-review-all-gdds` spec instead.
