...
# Skill Test Spec: /aesir-playtest-report

## Skill Summary

`/aesir-playtest-report` generates a structured playtest report from session notes or
...
- [ ] Has a next-step handoff (e.g., `/aesir-bug-report` for new issues found, `/aesir-design-review` for feedback)

---

## Director Gate Checks

None. `/aesir-playtest-report` is a documentation utility. The CD-PLAYTEST gate is a
...
**Input:** `/aesir-playtest-report` (user pastes session notes)
...
5. Next Steps: suggests `/aesir-bug-report` for the framerate issue and `/aesir-design-review`
...
**Input:** `/aesir-playtest-report` (3-tester session)
...
- [ ] `/aesir-bug-report` is NOT suggested for the already-reported issue
