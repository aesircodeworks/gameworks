...
> "Usage: `/aesir-team-live-ops [season name or event description]` — Provide the name or description of the season or live event to plan."
...
- Run `/aesir-design-review` on the season design document for consistency validation.
- Run `/aesir-sprint-plan` to schedule content creation work for the season.
- Run `/aesir-team-release` when the season content is ready to deploy.
