...
# Skill Test Spec: /aesir-team-live-ops
...
- [ ] Has a next-step handoff at the end referencing `/aesir-design-review`, `/aesir-sprint-plan`, and `/aesir-team-release`
...
**Input:** `/aesir-team-live-ops "Season 2: The Frozen Wastes"`
...
- [ ] Next steps reference `/aesir-design-review`, `/aesir-sprint-plan`, and `/aesir-team-release`
...
**Input:** `/aesir-team-live-ops "Season 3: Shadow Tournament"`
...
4. clarify presented with resolution options before season plan approval is offered
...
- [ ] clarify is used to surface the violation and offer resolution options (revise economy design, override with documented rationale, cancel)
...
**Input:** `/aesir-team-live-ops` (no argument)

**Expected behavior:**
1. Phase 1: No argument detected
2. Outputs: "Usage: `/aesir-team-live-ops [season name or event description]` — Provide the name or description of the season or live event to plan."
...
**Input:** `/aesir-team-live-ops "Season 1: The First Thaw"` (observed at Phase 3/4 transition)
...
**Input:** `/aesir-team-live-ops "Season 4: Desert Heat"`
...
- [ ] Next steps always include `/aesir-design-review`, `/aesir-sprint-plan`, and `/aesir-team-release`
