...
# Skill Test Spec: /aesir-design-system

## Skill Summary

`/aesir-design-system` guides the user through section-by-section authoring of a Game
...
**Input:** `/aesir-design-system [system-name]`
...
- [ ] Ends with next-step handoff: `/aesir-review-all-gdds` or `/aesir-map-systems next`
