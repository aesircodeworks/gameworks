...
# Skill Test Spec: /aesir-team-narrative
...
and world-builder in parallel). Uses `clarify` at each phase transition to
...
- [ ] Has a next-step handoff at the end (references `/aesir-design-review`, `/aesir-localize extract`, `/aesir-dev-story`)
...
**Input:** `/aesir-team-narrative faction introduction cutscene for the Ironveil faction`
...
2. `clarify` presents the narrative brief; user approves before Phase 2 begins
...
4. `clarify` presents world foundation and dialogue drafts; user approves before Phase 3 begins
5. Phase 3: level-designer is spawned; produces environmental storytelling layout, trigger placement, and pacing plan
6. `clarify` presents level narrative plan; user approves before Phase 4 begins
...
**Input:** `/aesir-team-narrative ironveil faction introduction cutscene`
...
- [ ] `clarify` presents at least 3 options including "stop and resolve first"
...
**Input:** `/aesir-team-narrative` (no argument)

**Expected behavior:**
1. Skill detects no argument is provided
2. Outputs usage guidance: e.g., "Usage: `/aesir-team-narrative [narrative content description]` — describe the story content, scene, or narrative area to work on (e.g., `boss encounter cutscene`, `faction intro dialogue`, `tutorial narrative`)"
...
- [ ] No `clarify` is used — output is direct guidance
...
**Input:** `/aesir-team-narrative ironveil faction introduction cutscene` (Phase 5 scenario)
...
- [ ] `clarify` offers the option to fix now vs. flag and proceed
...
**Input:** `/aesir-team-narrative ironveil surrender negotiation scene`
...
- [ ] `clarify` offers at least one option to resolve the missing prerequisite
...
- [ ] Next Steps handoff references `/aesir-design-review`, `/aesir-localize extract`, and `/aesir-dev-story`
...
- The "Retry with narrower scope" and "Skip this agent" resolution paths from the Error
  Recovery Protocol are not separately tested — they follow the same `clarify`
