...
# Skill Test Spec: /aesir-create-stories

## Skill Summary

`/aesir-create-stories` breaks a single epic into developer-ready story files. It reads
...
- [ ] Has a next-step handoff at the end (`/aesir-story-readiness`, `/aesir-dev-story`)
...
**Input:** `/aesir-create-stories [epic-name]`
...
- [ ] Blocking note names the specific ADR number and recommends `/aesir-architecture-decision`
...
**Input:** `/aesir-create-stories` (no argument)

**Expected behavior:**
1. Skill detects no argument is provided
2. Outputs a usage error: "No epic specified. Usage: /aesir-create-stories [epic-name]"
...
- [ ] Ends with next-step handoff: `/aesir-story-readiness` → `/aesir-dev-story`
...
- The story sizing rule (splitting large requirement groups) is not tested here
  — it is addressed in the `/aesir-create-stories` skill's internal logic.
