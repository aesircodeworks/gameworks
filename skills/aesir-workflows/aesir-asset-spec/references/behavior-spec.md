...
# Skill Test Spec: /aesir-asset-spec

## Skill Summary

`/aesir-asset-spec` generates per-asset visual specification documents from design
...
- [ ] Has a next-step handoff (e.g., assign to an artist, or `/aesir-asset-audit` later)

---

## Director Gate Checks

None. `/aesir-asset-spec` is a design documentation utility. Technical artists may
...
**Input:** `/aesir-asset-spec goblin-enemy`
...
**Input:** `/aesir-asset-spec player-sprite`
...
**Input:** `/aesir-asset-spec goblin-enemy orc-enemy treasure-chest`
