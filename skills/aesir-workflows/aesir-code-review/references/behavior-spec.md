...
# Skill Test Spec: /aesir-code-review

## Skill Summary

`/aesir-code-review` performs an architectural code review of source files in `src/`,
...
**Input:** `/aesir-code-review src/gameplay/health_component.gd`
...
**Input:** `/aesir-code-review src/ui/inventory_ui.gd`
...
**Input:** `/aesir-code-review src/core/save_system.gd`
...
**Fixture:**
- User calls `/aesir-code-review src/networking/`
- `src/networking/` directory does not exist

**Input:** `/aesir-code-review src/networking/`
...
**Input:** `/aesir-code-review src/gameplay/loot_system.gd`
...
- Test coverage checks (verifying corresponding test files exist) are a stretch
  goal not tested here; that is primarily the domain of `/aesir-test-evidence-review`.
