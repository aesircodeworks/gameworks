...
# Skill Test Spec: /aesir-story-done

## Skill Summary

`/aesir-story-done` closes the loop between design and implementation. Run at the
...
**Input:** `/aesir-story-done production/epics/core/story-light-pickup.md`
...
**Input:** `/aesir-story-done` (no argument)
...
**Input:** `/aesir-story-done production/epics/core/story-light-pickup.md` (full mode)
