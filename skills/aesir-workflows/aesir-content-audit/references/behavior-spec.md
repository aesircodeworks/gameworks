...
# Skill Test Spec: /aesir-content-audit

## Skill Summary

`/aesir-content-audit` reads GDDs in `design/gdd/` and checks whether all content
...
2. Skill outputs: "No content specifications found in GDDs — run /aesir-design-system first to define content lists"
...
- [ ] Output recommends running `/aesir-design-system`
