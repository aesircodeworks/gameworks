...
# Skill Test Spec: /aesir-create-architecture

## Skill Summary

`/aesir-create-architecture` guides the user through section-by-section authoring of a
...
- [ ] Has a next-step handoff at the end (`/aesir-architecture-review` or `/aesir-create-control-manifest`)
...
**Input:** `/aesir-create-architecture`
...
- [ ] Next-step handoff to `/aesir-architecture-review` or `/aesir-create-control-manifest` is present
...
- [ ] Ends with next-step handoff: `/aesir-architecture-review` or `/aesir-create-control-manifest`
...
- The required section list for architecture documents is defined in the skill
  body and in the `/aesir-architecture-review` skill — not re-enumerated here.
