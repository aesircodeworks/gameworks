...
# Skill Test Spec: /aesir-create-epics

## Skill Summary

`/aesir-create-epics` reads all approved GDDs and translates them into EPIC.md files,
...
- [ ] Has a next-step handoff at the end (`/aesir-create-stories`)
...
4. Skill suggests running `/aesir-design-system` and completing GDD approval first
...
- [ ] Ends with next-step handoff: `/aesir-create-stories [epic-slug]` per created epic
