...
# Skill Test Spec: /aesir-milestone-review

## Skill Summary

`/aesir-milestone-review` generates a comprehensive review of a completed milestone:
...
**Input:** `/aesir-milestone-review milestone-03`
...
**Fixture:**
- User calls `/aesir-milestone-review milestone-07`
- `production/milestones/milestone-07.md` does NOT exist

**Input:** `/aesir-milestone-review milestone-07`
