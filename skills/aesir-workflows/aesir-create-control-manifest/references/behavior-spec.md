...
# Skill Test Spec: /aesir-create-control-manifest

## Skill Summary

`/aesir-create-control-manifest` reads all Accepted ADRs from `docs/architecture/` and
...
- [ ] Has a next-step handoff at the end (`/aesir-create-epics` or `/aesir-create-stories`)
...
**Input:** `/aesir-create-control-manifest`
...
2. Skill outputs: "No ADRs found. Run `/aesir-architecture-decision` to create ADRs before generating the control manifest."
...
- [ ] Ends with next-step handoff: `/aesir-create-epics` or `/aesir-create-stories`
