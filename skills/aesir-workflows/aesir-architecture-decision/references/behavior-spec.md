...
# Skill Test Spec: /aesir-architecture-decision

## Skill Summary

`/aesir-architecture-decision` guides the user through section-by-section authoring of
...
**Input:** `/aesir-architecture-decision rendering-approach`
...
**Input:** `/aesir-architecture-decision [topic]`
...
**Input:** `/aesir-architecture-decision [same-topic]`
