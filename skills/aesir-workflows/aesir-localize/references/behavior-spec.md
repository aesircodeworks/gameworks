...
# Skill Test Spec: /aesir-localize

## Skill Summary

`/aesir-localize` manages the full localization pipeline: it extracts all player-facing
...
None. `/aesir-localize` is a pipeline utility. No director gates apply. Localization
...
5. Skill suggests fixing the file manually and re-running `/aesir-localize`
