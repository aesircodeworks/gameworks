...
# Skill Test Spec: /aesir-brainstorm

## Skill Summary

`/aesir-brainstorm` facilitates guided game concept ideation. It presents 2-4 concept
...
- [ ] Has a next-step handoff at the end (`/aesir-map-systems`)
...
- [ ] Next-step handoff to `/aesir-map-systems` is present
...
- [ ] Ends with next-step handoff: `/aesir-map-systems`
