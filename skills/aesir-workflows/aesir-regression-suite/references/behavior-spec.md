...
# Skill Test Spec: /aesir-regression-suite

## Skill Summary

`/aesir-regression-suite` maps test coverage to GDD requirements: it reads the
...
- [ ] Has a next-step handoff (e.g., `/aesir-test-setup` if framework missing, `/aesir-qa-plan` if plan missing)

---

## Director Gate Checks

None. `/aesir-regression-suite` is a QA analysis utility. No director gates apply.
...
**Input:** `/aesir-regression-suite sprint-004`
