...
# Skill Test Spec: /aesir-bug-report

## Skill Summary

`/aesir-bug-report` creates a structured bug report document from a user description.
...
- [ ] Has a next-step handoff (e.g., `/aesir-bug-triage` to reprioritize, `/aesir-hotfix` for critical)

---

## Director Gate Checks

None. `/aesir-bug-report` is an operational documentation skill. No director gates apply.
...
**Input:** `/aesir-bug-report` (user describes: "Game crashes when player enters the boss arena")
...
**Input:** `/aesir-bug-report` (user describes: "Audio randomly stops working")
...
**Input:** `/aesir-bug-report` (user describes: "After finishing a level, the save system
