...
# Skill Test Spec: /aesir-perf-profile

## Skill Summary

`/aesir-perf-profile` is a structured performance profiling workflow that identifies
...
**Input:** `/aesir-perf-profile production/qa/profiler-export-2026-03-15.json`
...
**Fixture:**
- User runs `/aesir-perf-profile` with no arguments
- No profiler data files exist in `production/qa/`

**Input:** `/aesir-perf-profile`
...
**Input:** `/aesir-perf-profile production/qa/profiler-export-2026-03-20.json`
...
**Input:** `/aesir-perf-profile production/qa/profiler-export-2026-04-05.json`
...
**Input:** `/aesir-perf-profile production/qa/profiler-export-2026-04-01.json`

**Expected behavior:**
1. Skill analyzes profiler data; verdict is CONCERNS
2. No director gate is invoked regardless of review mode
3. Output notes: "For in-depth analysis, consider running `/aesir-perf-profile` with the performance-analyst agent"
