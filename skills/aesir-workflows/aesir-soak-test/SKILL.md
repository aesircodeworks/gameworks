...
**When to run:**
- Polish phase — before `/aesir-gate-check release`
...
Read:
- `aesir-gameworks references/technical-preferences.md` — engine (for engine-specific memory
...
5. Run `/aesir-bug-triage sprint` after the session to integrate any S1/S2 issues

If the verdict is FAIL, run `/aesir-smoke-check` again after fixing the issues."
