...
# Skill Test Spec: /aesir-soak-test

## Skill Summary

`/aesir-soak-test` generates a structured soak test protocol — an extended runtime
...
- [ ] Has a next-step handoff (e.g., `/aesir-regression-suite` or `/aesir-release-checklist`)

---

## Director Gate Checks

None. `/aesir-soak-test` is a QA planning utility. No director gates apply.
...
**Input:** `/aesir-soak-test online-lobby 2h`
...
**Input:** `/aesir-soak-test online-lobby 4h`
...
**Input:** `/aesir-soak-test gameplay 30m`
...
**Input:** `/aesir-soak-test combat 1h`
