...
**Format**: `/aesir-reverse-document <type> <path>`
...
**Examples**:
```bash
/aesir-reverse-document design src/gameplay/magic-system
/aesir-reverse-document architecture src/core/entity-component
/aesir-reverse-document concept prototypes/vehicle-combat
```
...
1. Run /aesir-balance-check on combat formulas (exponential scaling concern)
...
```
User: /aesir-reverse-document design src/gameplay/[system]
...
Agent: ✅ Written to design/gdd/[system-name].md
       ...
       - Run /aesir-balance-check to validate [curve]
