...
# Skill Test Spec: /aesir-dev-story

## Skill Summary

`/aesir-dev-story` reads a story file, loads all required context (referenced ADR,
...
- [ ] Has a next-step handoff at the end (`/aesir-story-done`)
...
- `aesir-gameworks references/technical-preferences.md` has engine and language configured
- `production/session-state/review-mode.txt` contains `full`

**Input:** `/aesir-dev-story production/epics/[layer]/story-[name].md`
...
5. Skill recommends running `/aesir-architecture-decision` to advance the ADR
...
- [ ] Skill recommends `/aesir-architecture-decision` as the next action
...
**Input:** `/aesir-dev-story` (no argument)
...
- [ ] Ends with next-step handoff: `/aesir-story-done`
