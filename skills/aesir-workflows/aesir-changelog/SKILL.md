...
- Use `/aesir-patch-notes [version]` to generate a styled, saved version for public release.
- Use `/aesir-release-checklist` before publishing the changelog externally.
