...
# Skill Test Spec: /aesir-ux-design

## Skill Summary

`/aesir-ux-design` is a guided, section-by-section UX spec authoring skill. It produces
...
The skill has no inline director gates — `/aesir-ux-review` is the separate review step.
...
- [ ] Has a next-step handoff (e.g., `/aesir-ux-review` to validate the completed spec)

---

## Director Gate Checks

None. `/aesir-ux-design` has no inline director gates. `/aesir-ux-review` is the separate
...
6. Skill suggests running `/aesir-ux-review` as the next step
...
- [ ] Handoff to `/aesir-ux-review` is at the end
- [ ] Verdict is COMPLETE
...
**Input:** `/aesir-ux-design inventory-screen`
...
- [ ] Handoff suggests both `/aesir-ux-review` and writing the missing GDD
...
**Input:** `/aesir-ux-design`

**Expected behavior:**
1. Skill detects no screen name or argument provided
2. Skill outputs a usage error: "Screen name required. Usage: `/aesir-ux-design [screen-name]`"
3. Skill provides examples: `/aesir-ux-design hud`, `/aesir-ux-design main-menu`, `/aesir-ux-design inventory`
...
**Input:** `/aesir-ux-design settings-menu`
...
- [ ] Ends with handoff to `/aesir-ux-review`
...
- Interaction state enumeration (normal/hover/focus/disabled/error) is a core
  requirement of each spec; the `/aesir-ux-review` skill checks for completeness.
