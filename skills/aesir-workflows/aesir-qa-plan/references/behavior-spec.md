...
# Skill Test Spec: /aesir-qa-plan

## Skill Summary

`/aesir-qa-plan` generates a structured QA test plan for a feature or sprint milestone.
...
- [ ] Has a next-step handoff (e.g., `/aesir-smoke-check` or `/aesir-story-readiness`)

---

## Director Gate Checks

None. `/aesir-qa-plan` is a planning utility. Story readiness gates are separate.
...
**Input:** `/aesir-qa-plan sprint-003`
...
**Input:** `/aesir-qa-plan sprint-004`
