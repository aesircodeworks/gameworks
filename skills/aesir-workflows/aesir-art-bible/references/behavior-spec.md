...
# Skill Test Spec: /aesir-art-bible

## Skill Summary

`/aesir-art-bible` is a guided, section-by-section art bible authoring skill. It
...
- [ ] Has a next-step handoff (e.g., `/aesir-asset-spec` or `/aesir-design-system`)
...
- The art bible feeds into `/aesir-asset-spec` — this relationship is noted in the
