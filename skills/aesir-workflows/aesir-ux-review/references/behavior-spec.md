...
# Skill Test Spec: /aesir-ux-review

## Skill Summary

`/aesir-ux-review` validates an existing UX spec or HUD design document against
...
`/aesir-ux-review` IS the review gate for UX specs.
...
- [ ] Has a next-step handoff (e.g., back to `/aesir-ux-design` for revision, or proceed to implementation)

---

## Director Gate Checks

None. `/aesir-ux-review` is itself the review gate for UX specs. No additional director
...
6. Handoff suggests returning to `/aesir-ux-design hud` to fill in the section

**Assertions:**
- [ ] NEEDS REVISION verdict is returned (not APPROVED or MAJOR REVISION NEEDED)
- [ ] Specific missing content items are listed
- [ ] Handoff points back to `/aesir-ux-design hud` for revision
- [ ] No files are written
...
**Input:** `/aesir-ux-review settings-menu`
...
- [ ] Handoff suggests returning to `/aesir-ux-design settings-menu`
...
**Input:** `/aesir-ux-review inventory-screen`
...
3. Skill suggests running `/aesir-ux-design inventory-screen` to create the spec first
4. No review is performed; no verdict is issued

**Assertions:**
- [ ] Error message names the missing file with full path
- [ ] `/aesir-ux-design inventory-screen` is suggested as the remediation
...
- [ ] Ends with next-step handoff to `/aesir-ux-design` for revision or implementation
