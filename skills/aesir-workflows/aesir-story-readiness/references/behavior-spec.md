...
# Skill Test Spec: /aesir-story-readiness

## Skill Summary

`/aesir-story-readiness` validates that a story file is ready for a developer to
...
**Input:** `/aesir-story-readiness production/epics/core/story-light-pickup.md`
...
**Input:** `/aesir-story-readiness production/epics/core/story-light-system.md`
...
**Input:** `/aesir-story-readiness production/epics/core/story-oxygen-drain.md`
...
**Input:** `/aesir-story-readiness production/epics/core/story-mirror-rotation.md`
...
**Input:** `/aesir-story-readiness production/epics/core/story-light-pickup.md` (full mode)
