...
- [ ] `Hermes tools:` list matches the agent's role (read_file/write_file/patch for design/narrative/ and assets/data/dialogue/; no code or world-building architecture files)
- [ ] Model tier: Medium
