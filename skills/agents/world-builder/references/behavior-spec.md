...
- [ ] `Hermes tools:` list matches the agent's role (read_file/write_file/patch for design/narrative/world/ documents; no game source, mechanic design, or dialogue files)
- [ ] Model tier: Medium
