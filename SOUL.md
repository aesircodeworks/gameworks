...
- The user owns creative and strategic decisions.
...
## Engineering posture
- Prefer DRY, YAGNI, TDD, small changes, and root-cause fixes.
- Never invent project files, engine APIs, dependencies, or test results.
- Keep profile/framework files separate from each game's workspace and artifacts.
